...
internal class PathfinderResourceHelper(private val assetProvider: AssetProvider) {
    ...
    companion object {
        ...
        const val FONT_GREEK_ALIAS = "Greek"
        const val FONT_GREEK_ASSET = "Greek.ttf"

        const val LNT_SHIPMENT_LABEL_ALIAS = "ShipmentLabel"
        const val LNT_SHIPMENT_LABEL_ASSET = "LabelShipment.lnt"


        const val LNT_SAMPLE_ALIAS = "SampleLabel"
        const val LNT_SAMPLE_ASSET = "SampleLabel.LNT"

        const val LNT_SAMPLE_PRINT_ALIAS = "SamplePrint"
        const val LNT_SAMPLE_PRINT_ASSET = "SamplePrint.LNT"
    ...
    @Synchronized
    fun initialiseResources() : Boolean {
        ...
        try {
            ...
            if (!previouslyRegisteredFonts.contains(FONT_GREEK_ALIAS)) {
                registerResource(ResourceMediaType.Font, FONT_GREEK_ALIAS, FONT_GREEK_ASSET)
            }
            ...
            if (!previouslyRegisteredLnts.contains(LNT_SAMPLE_PRINT_ALIAS)) {
                registerResource(ResourceMediaType.Lnt, LNT_SAMPLE_PRINT_ALIAS, LNT_SAMPLE_PRINT_ASSET)
            }
