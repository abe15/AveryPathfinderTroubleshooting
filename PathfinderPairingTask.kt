...
internal class PathfinderPairingTask(
    ...
    fun setupScanningConfig(pathfinderScanner: PathfinderScanner) {
        try {
            with(pathfinderScanner) {
                ...
                executeConfigUpdate {
                    tryApiTask("Code128.setLength1(15) [40]") { configBarcode128.length1 = 15 }
                }
                executeConfigUpdate {
                    tryApiTask("Code128.setLength2(16) [40]") { configBarcode128.length2 = 16 }
                }

                executeConfigUpdate {
                    tryApiTask("DataMatrix.setEnabled(true) [41]") { scanner4500.dataMatrix.isEnabled = true }
                }
